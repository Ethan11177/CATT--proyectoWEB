...
<head>
    ...
    <script>
        ...
        $(document).ready(()=>{
            ...
            $.ajax({
                method:"POST",
                url:"./PHP/obtencion_datos_profesores.php",
                cache: false,
                success:(respAX)=>{            
                    ...
                    for (let index = 0; index < AX.num; index++) {
                            ...
                            hijo.innerHTML = "<td>"+AX.db[index][2]+"</td><td>"+ AX.db[index][3] +" "+ AX.db[index][4] +"</td><td>"+ AX.db[index][0] +"</td><td>"+AX.db[index][5]+"</td>"
            ...
            $("form#modificadorA").submit((e)=>{
                ...
                $.ajax({
                    method:"POST",
                    url:"./PHP/modificar_eliminar_profesor.php",
    ...
    <main class="cuerpo">
        <div>
            ...
            <form action="#" method="post" name="modificadorA" id="modificadorA">
                ...
                <label for="Correo">Correo que desea Modificar:</label>
                ...
                <input type="password" name="contrasena" id="contrasena" maxlength="10">
